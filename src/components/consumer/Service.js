...
function ConsumerService() {
    ...
    const [openDispute, setOpenDispute] = useState({ userId, message: "", type: "", against: "", subject: "", image: null, preview: null })
    ...
    async function fetchAddOnData() {
        try {
            ...
            if (result.status) {
                setDisputeAddOn(result.addOnData[0])
    ...
    return (
        ...
        <div className="main-section posting-histry-sec flex-grow-1">
            <div className="row dash-profile-overflow  pt-4 mx-lg-2 mx-sm-0">
                <h2 className="">Service Disputes</h2>
                {addOnData?.length > 0 ?
                        ...
                        <div className="posting-hostry-main-sec">
                            <div className="posting-hostry-title-header-box rating-usr-toggle-bx">
                                ...
                                <a href="" data-bs-toggle="modal"
                                    data-bs-target="#disputeModal" className="btn btn-primary report-btn">
                                    ...
                                    <table className="table custom-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>#282639</td>
                                                <td>5/27/2024</td>
                                                <td className="text-truncate-custom">Alex Supplies</td>
                                                <td className="text-truncate-custom">Delayed Delivery</td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-truncate-custom">Miss Commitment</td>
                                                <td className="text-truncate-custom">
                                                    Lorem ipsum dolor sit amet consectetur.
                                                </td>
                                                <td>
