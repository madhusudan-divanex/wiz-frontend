...
function ConsumerPostingHistory() {
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-12">
                                    <div className="d-flex justify-content-end align-items-center posting-hist-btn-bx gap-3">
                                        <a href="" className="btn btn-primary posting-hist-btn">
                                            Add your business profile
                                        </a>
                                        <Link
                                            to="/report-scam"
                                            className="btn btn-outline-primary posting-hist-btn post-outline-btn"
                                        >
                                            Report fraud{" "}
                                        </Link>
                                    </div>
...
export default ConsumerPostingHistory
const styles = {
  paginationContainer: {
    display: "flex",
