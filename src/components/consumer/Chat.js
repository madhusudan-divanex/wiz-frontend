...
function ConsumerChat() {
  ...
  useEffect(() => {
    if (!wiz && myChat.length > 0) {
      navigate(`/consumer/chat?wiz=${myChat[0]?.user?._id}`)
    }
  }, [myChat])
  ...
  return (
    <>
      {(myChat?.length > 0 || wiz) ? <div className="main-section posting-histry-sec flex-grow-1 chat-bx-section">
                        ...
                        {filterChat.length > 0 &&
                          filterChat.map((item, key) => (
                            <div className="dash-board-usr-my-conver" key={key}>
                              <Link to={`/consumer/chat?name=${item?.user?.firstName}&wiz=${item?.user?._id}`} onClick={() => setMobChat(true)} className="dash-online-sec">
                                ...
                                <span className="ms-auto">{timeAgo(item?.createdAt)}</span> {/* Use timeAgo function here */}
                              </Link>
                    ...
                    <div className="cht-customer-type-box">
                      <div>
                        <div className="cht-right-side-sec">
                          ...
                          <div className="cht-view-pro-btn">
                            <Link
                      ...
                      <div className="cht-type-bx position-relative ">
                        ...
                        <div className="chat-input-box">
                          ...
                          <div className="chat-actions position-relative mb-2">
                            <button type="button"
