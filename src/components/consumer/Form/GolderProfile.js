        ...
        try {
            ...
            if (result.status) {
                if (result.isNew && basketForm.receiveGiftBox) {
                    const modalEl = document.getElementById('basketModal');
    ...
    return (
        <>
            ...
            <section className="business-progress-form onboarding-section customer-main-section  py-4">
                <div className="container">
                    <div className="progress customer-progress-glod mb-4">
                        <div
                            id="progressBar"
                            className="progress-bar progress-bar-custm-gold"
                            role="progressbar"
                            style={{ width: "20%" }}
                            aria-valuenow={20}
                            aria-valuemin={0}
                    ...
                    >
                        <li className="nav-item flex-fill">
                            <a
                                className={`nav-link disabled iscustomr-gold ${currentStep === 1 ? 'active' : ''}`}
                                data-step={0}
                                type="button" onClick={() => handleTabClick(1)}
                            >
                                Profile
                            </a>
                        </li>
                        <li className="nav-item flex-fill">
                            <a
                                className={`nav-link disabled iscustomr-gold ${currentStep === 2 ? 'active' : ''}`}
                                data-step={1}
                                type="button" onClick={() => handleTabClick(2)}
                            >
                                Welcome Basket
                            </a>
                        </li>
                        <li className="nav-item flex-fill">
                            <a
                                className={`nav-link disabled iscustomr-gold ${currentStep === 3 ? 'active' : ''}`}
                                data-step={2}
                                type="button" onClick={() => handleTabClick(3)}
                            >
                        ...
                        <li className="nav-item flex-fill">
                            <a
                                className={`nav-link disabled iscustomr-gold ${currentStep === 4 ? 'active' : ''}`}
                                data-step={3}
                                type="button" onClick={() => handleTabClick(4)}
                            >
                        ...
                        <li className="nav-item flex-fill">
                            <a
                                className={`nav-link disabled iscustomr-gold ${currentStep === 5 ? 'active' : ''}`}
                                data-step={4}
                                type="button" onClick={() => handleTabClick(5)}
                            >
                                Stay Updated
                            </a>
                        </li>
                    ...
                    <div id="multiStepForm">
                        {/* Step 1 */}
                        {currentStep == 1 && <div className="step">
                                        ...
                                        <div className="col-lg-12 col-md-6 col-sm-12">
                                            <div className="form-check-card mb-3 position-relative">
                                                <div className="form-check frm-check-business">
                                                    <input
                                                        className="form-check-input styled-check styled-check styled-check-gld"
                                                        type="checkbox"
                                                        id="consumerCheck"
                                                    ...
                                                    />
                                                    <label
                                                        className="form-check-label card-style card-style-gld"
                                                        ...
                                                        <div className="d-flex">
                                                            <div className="business-opt-box-content">
                                                                ...
                                                                <p className="mb-0 small text-muted">
                                                                    <a href="#" className="gld-view-btn-txt">
                                                                        View Example
                                                                    </a>
                                                                </p>
                                                            </div>
                            ...
                            {selectedType == 'individual' &&
                                <form onSubmit={profileSubmit} id="individualForm" >
                                    <div className="row mt-5 individual-form">
                                        <div className="col-lg-6 col-md-6 col-sm-12">
                                            <div className="custom-frm-bx">
                                                <label htmlFor="">
                                                    First name
                                                    <span className="start-icon start-icon-gold">*</span>
                                                </label>
                                                <input
                                                    type="text"
                                        ...
                                        <div className="col-lg-6 col-md-6 col-sm-12">
                                            <div className="custom-frm-bx">
                                                <label htmlFor="">
                                                    Gender <span className="start-icon start-icon-gold">*</span>
                                                </label>
                                                <div className="d-flex gap-3">
                                                    <div className="form-check custom-radio-purple">
                                                        <input
                                                            className="form-check-input form-check-input-gold"
                                                            type="radio"
                                                            name="gender"
                                                            value="male"
                                                            onChange={profileChange}
                                    ...
                                    <div className="business-submt-btn d-flex justify-content-end">
                                        <div>
                                            <button
                                                type="submit"
                                                className="btn btn-primary mt-4 btn-next gold-next-btn"
                                            >
                                                Save and Continue
                                            </button>
                                        </div>
                            ...
                            <form onSubmit={basketSubmit} className="step  marketing-sec">
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-12">
                                        <div className="custom-frm-bx">
                                            <div className="form-check">
                                                <input
                                                    className="form-check-input custom-checkbox custom-checkbox custom-glod-chckbox"
                                                    type="checkbox"
                                                    name="receiveGiftBox"
                                ...
                                <div className="row marketing-border-btm py-4">
                                    <div className="col-lg-6 col-md-6 col-sm-12">
                                        <div className="custom-frm-bx">
                                            <label htmlFor="">
                                                Address <span className="start-icon start-icon-gold">*</span>
                                            </label>
                                            <input
                                                type="text"
                                                className="form-control"
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-12 location-input">
                                        <div className="custom-frm-bx option-size">
                                            <label htmlFor="">
                                                Emirate <span className="start-icon start-icon-gold">*</span>{" "}
                                            </label>
                                            <select name="emirate"
                                    ...
                                    <div className="col-lg-6 col-md-6 col-sm-12">
                                        <div className="custom-frm-bx d-flex flex-column">
                                            <label htmlFor="">
                                                Contact Number <span className="start-icon start-icon-gold">*</span>{" "}
                                            </label>
                                            <ReactIntlTelInput
                                        ...
                                        {/* <div className="row">
                                            <div className="col-lg-4 col-md-4 col-sm-12 location-input">
                                                <div className="custom-frm-bx option-size">
                                                    <label htmlFor="">
                                                        Contact No{" "}
                                                        <span className="start-icon start-icon-gold">*</span>{" "}
                                            ...
                                            <div className="col-lg-8 col-md-8 col-sm-12 location-input">
                                                <div className="custom-frm-bx option-size">
                                                    <label htmlFor="">
                                                        Phone{" "}
                                                        <span className="start-icon start-icon-gold">*</span>{" "}
                                ...
                                <div className="business-submt-btn d-flex justify-content-between">
                                    <div>
                                        <button
                                            ...
                                            className="btn btn-outline-primary mt-4 btn-prev gold-prev-btn"
                                        >
                                            Previous Page
                                        </button>
                                    </div>
                                            ...
                                            {servicesList?.map((item, key) =>
                                                <div className="col-lg-12 col-md-12 col-sm-12" key={key}>
                                                    <div className="custom-frm-bx custom-frm-bx-small">
                                                        <div className="d-flex align-items-center  form-check check-fm-box-bordr">
                                                            <input
                                                                className="form-check-input frm-chck-inpt custom-glod-chckbox"
                                                                type="checkbox"
                                            ...
                                            <div className="col-lg-12 col-md-12 col-sm-12">
                                                <div className="custom-frm-bx custom-frm-bx-small">
                                                    <div className="form-check check-fm-box-bordr">
                                                        <input
                                                            className="form-check-input frm-chck-inpt custom-glod-chckbox mt-0"
                                                            type="checkbox"
                                                ...
                                                <div className="custom-frm-bx custom-frm-bx-small">
                                                    <div className="form-check check-fm-box-bordr">
                                                        <input
                                                            ...
                                                            type="checkbox"
                                                            name='promotions'
                                                            checked={stayUpdated.promotions} onChange={stayUpdatedChange}
                ...
                <div>
                    <div className="delete-model-section modal fade" id="basketModal" tabindex="-1" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content p-4">
                                ...
                                <span className='fw-600' style={{ color: '#EEBD5B' }}>Resend Code</span>
                                <div className="d-flex gap-2 mt-3">
                                    <button onClick={sendBasket} className="deleteBtn  gold-primary">Continue</button>

                                    <a herf="javascript:void(0)" data-bs-dismiss="modal" onClick={() => setCurrentStep(currentStep + 1)} id="submitBtn" className="btn  deleteBtn gold-secondary">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="delete-model-section modal fade" id="successModal" tabindex="-1" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content p-5">
                                ...
                                <div className="d-flex gap-2 mt-3">
                                    <button data-bs-dismiss="modal" className="deleteBtn  gold-primary" onClick={() => setCurrentStep(currentStep + 1)}>Continue</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="delete-model-section modal fade" id="failModal" tabindex="-1" aria-hidden="true">
                        <div className="modal-dialog modal-dialog-centered">
                            <div className="modal-content p-5">
                                <div className="text-start">
                                ...
                                <div className="d-flex gap-2 mt-3">
                                    <button data-bs-dismiss="modal" className="deleteBtn  gold-primary">Continue</button>
                                </div>
                            </div>
                        </div>
                    </div>
