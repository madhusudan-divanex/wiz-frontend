...
const CompanyForm = ({ active, profileData }) => {
    ...
    return (
        <div id="individualForm" className={`${active} ? 'd-block' : 'd-none'`}>
            <h5 className="mb-2 fw-semibold py-2">Company: Enter Your Details</h5>
            ...
            <form onSubmit={handleSubmit}>
                <div className="row mt-5 individual-form">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <label htmlFor="c">
                                Company Name <span className="start-icon start-icon-gold">*</span>
                            </label>
                            <input
                                type="text"
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            ...
                            <div className="form-check mt-2 form-check-first">
                                <input
                                    className="form-check-input form-chk-input custom-checkbox position-relative custom-glod-chckbox ms-0"
                                    type="checkbox"
                                    id="checkDefaultone"
                        ...
                        <div className="custom-frm-bx">
                            <label  style={{ width: "100%" }}>
                                ...
                                >
                                    ...
                                    <div className="d-flex justify-content-center gap-2">
                                        <div>
                                            <p className="fw-semibold mb-1 text-primary">
                                                <label htmlFor="fileInput1" style={{cursor:"pointer"}} className='text-primary file-label file-label-gold'> Click to upload </label> or drag and drop
                                            </p>
                                    ...
                                    {values?.bannerImage && <div id="filePreview1" className=" mt-3">
                                        <img
                        ...
                        <div className="custom-frm-bx">
                            <label  style={{ width: "100%" }}>
                                <div className="upload-box upload-gold-box p-4 text-center" id="uploadArea2">
                                    ...
                                    {values?.profileImage && <div id="filePreview2" className=" mt-3">
                                        <img
                ...
                <div className="row busines-frm-categries-sec pt-4">
                    ...
                    <p>You can add up to 3 categories and 6 services.</p>
                    ...
                    {values.categories.length < 3 && (
                        <div className="col-12">
                            <button
                                type='button'
                                className=" gold-plus gold-plus mt-3"
