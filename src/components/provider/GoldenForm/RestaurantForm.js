...
const RestaurantForm = ({ active, profileData }) => {
    ...
    return (
        <div id="individualForm" className={`${active} ? 'd-block' : 'd-none'`}>
            <h5 className="mb-2 fw-semibold py-2">Restaurant: Enter Your Details</h5>
                ...
                <div className="row mt-5 individual-form">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <label htmlFor="c">
                                Company Name <span className=" gold-plus blue-plus mt-3">*</span>
                            </label>
                            <input
                                type="text"
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <label htmlFor="">
                                Head Office Location <span className=" gold-plus blue-plus mt-3">*</span>
                            </label>
                                    ...
                                    <div className="d-flex justify-content-center gap-2">
                                        <div>
                                            <p className="fw-semibold mb-1 text-primary">
                                                <label htmlFor="fileInput1" className='text-primary file-label file-label-gold'> Click to upload </label> or drag and drop
                                            </p>
