    ...
    return (
        <form onSubmit={handleSubmit} className={isFormDisabled ? 'form-disabled' : ''}>
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 pt-lg-0 pt-md-2">
                    <div className="custom-frm-bx">
                        <div className="form-check">
                            <input
                                className="form-check-input form-check-input-gold custom-checkbox custom-glod-chckbox"
                                type="checkbox"
                                name="hasLicense"
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12">
                            <div className="custom-frm-bx">
                                <label htmlFor={`fileInput-${licenseIndex}`} style={{ width: "100%" }} className={isFormDisabled ? 'form-disabled' : ''}>
                                    <div className="upload-box upload-gold-box  p-4 text-center" id={`uploadArea-${licenseIndex}`}>
                                        ...
                                        <p className="fw-semibold mb-1">
                                            <label
                                                ...
                                                className="text-primary file-label file-label-gold"
                            ...
                            <div className="row">
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="custom-frm-bx">
                                        <label htmlFor="">Enter your trade license number <span className="start-icon d-none">*</span></label>
                                        <input
                                            type="text"
                            ...
                            <div className="row align-items-end" aria-colspan="trade-lic-text">
                                <div className="col-lg-6 col-md-6 col-sm-12">
                                    <div className="custom-frm-bx">
                                        <label htmlFor="">Trade license validity: <span className="start-icon d-none">*</span></label>
                                        <input
                                            type="date"
                                            className="form-control"
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="custom-frm-bx">
                                    <label htmlFor="">
                                        Under what name is your trade license issued? <span className="start-icon d-none">*</span>
                                    </label>
                                    <input
                                        type="text"
                                        className="form-control"
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="custom-frm-bx option-size">
                                    <label htmlFor="">
                                        ...
                                        <span className="start-icon d-none">*</span>{" "}
                                    </label>
                                    <select
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="custom-frm-bx">
                                    <label htmlFor="">Year of Company Formation <span className="start-icon d-none">*</span></label>
                                    <input
                                        type="text"
                                        className="form-control"
                            ...
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="custom-frm-bx">
                                    <label htmlFor="">Please select where your license is issued <span className="start-icon d-none">*</span></label>
                            ...
                            {license.companyFormationType === 'Freezone' && (
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="custom-frm-bx">
                                        <label htmlFor="">Name of the Freezone <span className="start-icon d-none">*</span></label>
                                        <input
                                            type="text"
                                            className="form-control"
                            ...
                            {license.companyFormationType === 'Mainland' && (
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="custom-frm-bx">
                                        <label htmlFor="">Name of the Mainland <span className="start-icon d-none">*</span></label>
                                        <input
                                            type="text"
                                            className="form-control"
                                            placeholder="Enter name"
                    ...
                    <div className="d-flex justify-content-center gap-4">
                        <div className="business-add-btn">
                            <button
                                ...
                                className="blue-plus p-0 border-0 align-baseline gold-another-btn"
                            >
                                ...
                                <div className="custom-frm-bx custom-frm-bx-small">
                                    <div className="form-check check-fm-box-bordr ">
                                        ...
                                        <label className="form-check-label" htmlFor={`checkDefaultactive-${index}`}>
                                            Active&nbsp;as of <span style={{ color: "#EEBD5B" }}>{currentDate}</span>
                                        </label>
                                    </div>
                                </div>
                                <div className="custom-frm-bx custom-frm-bx-small">
                                    <div className="form-check check-fm-box-bordr">
                                        <input
                                            className="form-check-input form-check-input-gold custom-checkbox custom-glod-chckbox" style={{ marginTop: "0" }}
                                            type="checkbox"
                    ...
                    <div className="row marketing-border-btm pt-4 ">
                        {formData.additionalCertificates.map((certificate, index) => (
                            <div key={index} className="certificate-item mb-4 p-3 border rounded">
                                ...
                                <h6 className='text-nowrap'>Certificate #{index + 1}</h6>
                                ...
                                {/* <div className="ms-3">
                                    <input
                                        ...
                                        name='showOnProfile'
                                        placeholder="Enter certificate name"
                                        checked={certificate.showOnProfile}
                                        onChange={(e) => handleCertificateChange(index, 'showOnProfile', e.target.checked)}
                                        id={`certificateName-${index}`}
                                    />
                                    <label className='form-check-label ms-3' htmlFor='showOnProfile'>Show on profile page</label>
                                </div> */}
                                </div>
                                <div className="d-flex justify-content-between mt-2">
                                    {index === formData.additionalCertificates.length - 1 && (
                                        <div className='d-flex business-add-btn justify-content-start w-100'>
                                            <button
                                                type="button"
                                                className="blue-plus gold-another-btn"
            ...
            <div className="row pt-4 mt-2" style={{ borderTop: "1px solid rgb(228, 231, 236)" }}>
                <div className="col-lg-6 col-md-6 col-sm-12" >
                    <h4>Terms and Conditions<sup className="start-icon d-none fs-6 " style={{ top: "-.4em" }}>*</sup></h4>
                </div>
                <div className="col-lg-6 col-md-6 col-sm-12">
                    <div className="custom-frm-bx">
                        <div className="form-check">
            ...
            <div className="business-submt-btn d-flex justify-content-between">
                <div className="business-submt-out-btn">
                    <button
                        type="button"
                        className="btn btn-outline-primary btn-prev mt-4 gold-prev-btn"
                ...
                <div className="business-submt-btn d-flex justify-content-end">
                    <button
                        type="submit"
                        className="btn btn-primary mt-4  gold-next-btn"
                        disabled={loading}
                    >
