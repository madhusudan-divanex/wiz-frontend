        ...
        <div id="individualForm" className={`${active} ? 'd-block' : 'd-none'`}>
            ...
            <form onSubmit={handleSubmit}>
                <div className="row mt-5 individual-form">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <label htmlFor="Name">Name <span className="start-icon start-icon-gold">*</span></label>
                            <input
                                type="text"
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <label htmlFor="">
                                Title <span className="start-icon start-icon-gold">*</span>
                            </label>
                            <input
                                type="text"
                                className="form-control"
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <label htmlFor="">
                                Company / Organization <span className="start-icon start-icon-gold">*</span>
                            </label>
                            <input
                                type="text"
                                className="form-control"
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <label htmlFor="">
                                Head Office Location <span className="start-icon start-icon-gold">*</span>
                            </label>
                ...
                <div className="row file-upload-box business-border-bottom py-4">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            <h5 className="mb-2">Banner Image  </h5>
                            <span className='upload-size-title'>Size 1650px x 500px</span>
                            {/* <span>Connect with the right expats through your profile. (Size 1650px x 500px)</span> */}
                            <div className="form-check mt-2 form-check-first ms-4">
                                <input
                                    className="form-check-input form-chk-input custom-checkbox custom-glod-chckbox"
                                    type="checkbox"
                                    id="checkDefaultone"
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                        <div className="custom-frm-bx">
                            <label  style={{ width: "100%" }}>
                                <div
                                    className="upload-box upload-gold-box p-4 text-center"
                                    id="uploadArea1"
                                ...
                                >
                                    ...
                                    <div className="d-flex justify-content-center gap-2">
                                        <div>
                                            <p className="fw-semibold mb-1 text-primary ">
                                                <label htmlFor='fileInput1' className='text-primary file-label file-label-gold' style={{cursor:"pointer"}}> 
                                                    Click to upload 
                                        ...
                                        <div className="d-flex justify-content-end position-relative">
                                           {/* <span className='file-ext-gold text-uppercase'>{typeof values?.bannerImage === 'object'
                                    ...
                                    {values?.bannerImage && <div id="filePreview1" className="d-none mt-3">
                                        <img
                                            src=""
                                            alt="Preview"
                ...
                <div className="row file-upload-box mt-5 business-border-bottom py-4">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="custom-frm-bx">
                            ...
                            <span className='upload-size-title'>Size 500px x 500px</span>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                        <div className="custom-frm-bx">
                            <label htmlFor="fileInput2" style={{ width: "100%" }}>
                                <div className="upload-box upload-gold-box p-4 text-center" id="uploadArea2">
                                    <div className="upload-icon mx-auto mb-2">
                                        <img
                                            src={uploadImg}
                                            alt="Upload"
                                    ...
                                    <div className="d-flex justify-content-center gap-2">
                                        ...
                                        <div className="d-flex justify-content-end position-relative">
                                           {/*{/* <span className='file-ext-gold text-uppercase'>{typeof values?.profileImage === 'object'
                                    ...
                                    {values?.profileImage && <div id="filePreview2" className="d-none mt-3">
                                        <img
                                            src=""
                                            alt="Preview"
                                            className="img-thumbnail"
                ...
                <div className="row busines-frm-categries-sec pt-4">
                    <h4>My Categories & Services</h4>
                    <p>Please note: You can add up to 3 categories and 6 services.</p>
                    ...
                    {values?.categories?.map((cat, index) => (
                        <div className="row mb-3" key={index}>
                            ...
                            <div className="col-lg-6 col-md-6 col-sm-12 mt-4 select-optn-fmr gold-select">
                                <label></label>
                                <Select
                                    style={{ color: "grey" }}
                                    mode="multiple"
                    ...
                    {values.categories.length < 3 && (
                        <div className="col-12">
                            <button
                                type='button'
                                className=" gold-plus blue-plus mt-3"
                ...
                <div className="business-submt-btn d-flex justify-content-end py-4 ">
                    <button
                        type="submit"
