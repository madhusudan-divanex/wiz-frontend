        ...
        <form>
            ...
            {selectedType === 'restaurant' && <div className="row marketing-border-btm py-4 additional-sec mb-3">
                <div className="col-lg-6 col-md-6 col-sm-12 file-upload-box">
                    <h5 style={{ fontSize: "18px", fontWeight: "600" }}>Add Your Restaurant Menu</h5>
                    <div className="custom-frm-bx">
                        <label htmlFor="fileInput3" style={{ width: "100%" }}>
                            <div className="upload-box  p-4 text-center upload-gold-box" id="uploadArea3">
            ...
            <div className="row marketing-border-btm py-4 additional-sec mb-3">
                <div className="col-lg-6 col-md-6 col-sm-12">
                    <h5 style={{ fontSize: "18px", fontWeight: "600" }}>Additional Section  (Optional)</h5>
                    <p>
                    ...
                    {section.type === "text" ? (
                        ...
                        <div className='row marketing-border-btm py-4 gallery-multi-image-section'>
                            <div className='col-lg-6'>
                                <div className="custom-frm-bx">
                                    <label htmlFor="">Add a Gallery </label>
                                    <input
                                        type="text"
                                ...
                                <div className='file-upload-box'>
                                    <div className="custom-frm-bx mb-0 pb-0">
                                        <span className='fw-600 text-black'>Add Photo</span>
                                        <label htmlFor={`fileInput_gallery_${index}`} style={{ width: "100%" }}>
                                            <div
                                                className="upload-box p-4 text-center upload-gold-box"
                                                id="uploadArea1"
                                                style={{ cursor: "pointer" }}
                                            >
                                                <div className="upload-icon mx-auto mb-2">
                                                ...
                                                <div className="d-flex justify-content-center gap-2">
                                                    <div>
                                                        <p className="fw-semibold mb-1 text-primary">
                                                           <span className='text-primary file-label file-label-gold'>
                                                            Click to upload </span>upto 9 Images or drag and drop
                                                        </p>
                                                        <small className="text-muted">
                ...
                <div className="col-lg-12 col-md-12 col-sm-12">
                    <div className="d-flex justify-content-center gap-4 bus-categories-add-mob">
                        <div className="business-add-btn">
                            <a role='button ' className='gold-another-btn' onClick={addTextSection}><i className="fa-solid fa-plus" />Add another text category</a>
                        </div>
                        <strong>OR</strong>
                        <div className="business-add-btn">
                            <a role='button' className='gold-another-btn' onClick={addGallerySection}>
            ...
            <div className="row py-4 marketing-border-btm" style={{ borderBottom: "1px solid #E4E7EC" }}>
                <div className="col-lg-6 col-md-6 col-sm-12">
                    <h5 className='fs-4'>Your Thought Leadership Portfolio (Optional) </h5>
                    <p>
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 file-upload-box ">
                    <div className="custom-frm-bx mb-0">
                        <div className="form-check">
                            ...
                            >
                                Share images or URL links to blogs, podcasts, books, social media <br /> <span className='upload-size-title'
                            ...
                            <>
                                <div className="custom-frm-bx mb-2 mt-2">
                                    <label htmlFor={`fileInput5_${index}`} style={{ width: "100%" }} className={`${!keepPortfolio ? 'disabled-upload' : ''}`}>
                                        <div className="upload-box  p-4 text-center upload-gold-box" id="uploadArea4">
                                            <div className="upload-icon mx-auto mb-2">
                                                <img
                                                    src={uploadImg}
                                                    alt="Upload"
                                            ...
                                            <div className="d-flex justify-content-center gap-2">
                                                ...
                                                <div className="d-flex justify-content-end position-relative">
                                                    {/* <span className='file-ext-gold text-uppercase'>{item?.imageUrl?.split('.')?.pop('')}</span> */}
                                                    <img
                                                        src="/assets/images/file-types.png"
                                                        alt=""
                                                        style={{ width: 40, height: 40 }}
                    ...
                    <div className="d-flex justify-content-start mt-2">
                        <div className="business-add-btn">
                            <a role='button' className='gold-another-btn' onClick={addPortfolioItem}>
                                <i className="fa-solid fa-plus" />
                                Share another resource or link 
                            </a>
                        </div>
                    </div>
                </div>
            </div>
            <div className="row justify-content-end file-upload-box mt-5 business-border-bottom ">
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 mb-4">
                    ...
                    <div className="custom-frm-bx">
                        <div className="form-check mt-2 form-check-first">
                            <input
                                className="form-check-input form-chk-input custom-checkbox custom-glod-chckbox  position-relative ms-0"
                                type="checkbox"
            ...
            <div className="business-submt-btn d-flex justify-content-between">
                ...
                <div>
                    <button type="button" className="btn btn-primary mt-4 btn-next  gold-next-btn" onClick={handleSubmit} disabled={isSubmitting}>
